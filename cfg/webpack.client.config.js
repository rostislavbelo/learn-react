...
const COMMON_PLUGINS = [new DefinePlugin({"process.env.REACT_APP_CLIENT_ID": `'${process.env.REACT_APP_CLIENT_ID}'`}, {"process.env.REACT_APP_SECRET": `'${process.env.REACT_APP_SECRET}'`})];
